...
class TAppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(style: TOutlinedButtonTheme.lightOutlinedButtonTheme),
  ...
  static ThemeData darkTheme = ThemeData(
     ...
     outlinedButtonTheme: OutlinedButtonThemeData(style: TOutlinedButtonTheme.darkOutlinedButtonTheme),
